...
public class MyGraphics {
    ...
    public void VeDiem(Point[] luudiem, int index, int label) {
        int i = 0;
        ...
        try {
            if(label==1)
                img = ImageIO.read(new File("images/user_boy.png"));
            else if(label==2)
                img = ImageIO.read(new File("images/user_girl.png"));
            else
        ...
        g2d.drawString(index +"", temp.x, temp.y);
